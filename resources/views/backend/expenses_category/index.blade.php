        ...
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="bg-gray-50 text-gray-600 text-xs uppercase font-semibold border-b border-gray-200">
                    ...
                    <th class="px-6 py-3">Paid Via</th>
            ...
            <tbody class="divide-y divide-gray-200 text-sm text-gray-700">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4"><span class="bg-blue-50 text-blue-700 px-2 py-1 rounded text-xs">{{ $detail->type }}</span></td>
                    <td class="px-6 py-4">{{ $detail->account->name }}</td>
                    <td class="px-6 py-4">{{ $detail->representative }}</td>
                    <td class="px-6 py-4 text-right font-bold text-red-600">-${{ number_format($detail->amount, 2) }}</td>
                </tr>
                @empty
                <tr>
