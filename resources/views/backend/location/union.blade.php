    ...
    <div class="flex items-center justify-between px-9">
        <div class="">
            <span class="inline-flex rounded-md shadow-sm">
                <a href="{{route('union.create',$upazila_id)}}"
        ...
        <div>
            <form action="{{route('union.view',$upazila_id)}}" method="get" class="w-full">
                <div class="flex items-center justify-center mb-10">
                    ...
                    <div class="mt-1.5">
                        ...
                        <a href="{{route('union.view',$upazila_id)}}"
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="flex px-8 py-8 space-x-2 text-sm font-medium text-right whitespace-nowrap">
                            ...
                            <a title="Delete" href="{{route('union.delete',$union->id)}}"
