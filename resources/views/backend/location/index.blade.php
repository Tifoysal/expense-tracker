...
@section('content')<div class="container flex flex-col px-8">
    ...
    <div class="flex items-center justify-between px-9">
        ...
        <div>
            <form action="{{route('location.division')}}" method="get" class="w-full">
                <div class="flex items-center justify-center mb-10">
                    ...
                    <div class="mt-1.5">
                        ...
                        <a href="{{route('location.division')}}" class="focus:outline-none space-x-6 bg-indigo-600 text-white rounded-md px-4 py-2.5 ml-5 mt-5">
                            Reset
                        </a>
                        @endif
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="flex px-8 py-8 space-x-2 text-sm font-medium text-right whitespace-nowrap">
                            ...
                            <a title="Delete" href="{{route('division.delete',$division->id)}}" onclick="return confirm('Are you sure you want to delete it ?')" class="text-indigo-600 hover:text-indigo-900">
                                <svg class="w-5 h-5 text-red-600" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd" />
                                </svg>
                            </a>
                            <a title="view" href="{{route('district.view',$division->id)}}" class="text-indigo-600 hover:text-indigo-900">
