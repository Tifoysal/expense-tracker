...
@section('content')<div class="container flex flex-col px-8">
    ...
    <div class="flex items-center justify-between px-9">
        ...
        <div>
            <form action="{{route('district.view',$division_id)}}" method="get" class="w-full">
                <div class="flex items-center justify-center mb-10">
                    ...
                    <div class="mt-1.5">
                        ...
                        <a href="{{route('district.view',$division_id)}}" class="focus:outline-none space-x-6 bg-indigo-600 text-white rounded-md px-4 py-2.5 ml-5 mt-5">
                            Reset
                        </a>
                        @endif
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="flex px-8 py-8 space-x-2 text-sm font-medium text-right whitespace-nowrap">
                            ...
                            <a title="Delete" href="{{route('district.delete',$district->id)}}"
                            ...
                            <a title="view" href="{{route('upazila.view',$district->id)}}" class="text-indigo-600 hover:text-indigo-900">
